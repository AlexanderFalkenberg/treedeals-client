<template>
  <div class="relative w-full lg:my-2 lg:-mx-2">
    ...
    <div
      class="h-full absolute top-0 right-0 lg:rounded-l text-green-800 px-7 lg:px-4 flex items-center"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 512 512"
        class="h-5 w-8 fill-current"
        style="top: 9px"
      >
        <path
    ...
    <input
      ...
      class="w-full border-b lg:border lg:rounded-md text-gray-700 outline-none focus:outline-none focus:shadow-outline-green focus:ring-2 focus:ring-offset-0 focus:ring-green-100 pl-4 sm:pl-6 px-3 py-4 lg:py-3"
    />
    <!-- Suggestions list -->
    <div class="relative">

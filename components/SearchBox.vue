<template>
  <div class="relative w-full lg:my-2 lg:-mx-2">
    ...
    <input
      ...
      class="w-full border-b lg:border lg:rounded-md text-gray-700 outline-none focus:outline-none focus:shadow-outline-green focus:ring-2 focus:ring-offset-0 focus:ring-green-100 pl-4 sm:pl-6 px-3 py-4"
    />
    <!-- Suggestions list -->
    <div class="relative">

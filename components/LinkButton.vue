<template>
  <a
    ...
    :class="[
      ...
      'rounded relative w-full min-w-button text-white tracking-wider uppercase inline-flex items-center whitespace-nowrap font-bold text-xs  transition duration-150 ease-in-out',
    ]"
    :href="link"
    target="_blank"
  >

    ...
    <div class="flex-1 pl-0 relative">
      ...
      >
        <span
          ...
          class="inline-flex rounded justify-center items-center md:h-auto md:w-auto text-xs font-medium text-red-100 bg-green-600 py-1 px-2"
        >
          Nachhaltig
        </span>
        <span
          v-if="deal.content.free_shipping"
          class="inline-flex rounded justify-center items-center md:h-auto md:w-auto text-xs text-red-100 font-medium bg-gray-800 py-1 px-2"
        >
          Kostenloser Versand
        </span>
      </div>
